...
class IndicesNamespace extends AbstractNamespace
{
    ...
    /**
     * Providers statistics on operations happening in a data stream.
     *
    ...
    /**
     * Providers low-level information about segments in a Lucene index.
     *
     * $params['index']              = (list) A comma-separated list of index names; use `_all` or empty string to perform the operation on all indices
     * $params['ignore_unavailable'] = (boolean) Whether specified concrete indices should be ignored when unavailable (missing or closed)
     * $params['allow_no_indices']   = (boolean) Whether to ignore if a wildcard indices expression resolves into no concrete indices. (This includes `_all` string or when no indices have been specified)
    ...
    /**
     * Providers store information for shard copies of indices.
     *
     * $params['index']              = (list) A comma-separated list of index names; use `_all` or empty string to perform the operation on all indices
    ...
    /**
     * Providers statistics on operations happening in an index.
     *
