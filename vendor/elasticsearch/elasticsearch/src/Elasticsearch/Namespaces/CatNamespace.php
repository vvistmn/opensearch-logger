...
class CatNamespace extends AbstractNamespace
{
    ...
    /**
     * Providers a snapshot of how many shards are allocated to each data node and how much disk space they are using.
     *
    ...
    /**
     * Providers quick access to the document count of the entire cluster, or individual indices.
     *
    ...
    /**
     * Providers low-level information about the segments in the shards of an index.
     *
     * $params['index']  = (list) A comma-separated list of index names to limit the returned information
     * $params['format'] = (string) a short version of the Accept header, e.g. json, yaml
     * $params['bytes']  = (enum) The unit in which to display byte values (Options = b,k,kb,m,mb,g,gb,t,tb,p,pb)
    ...
    /**
     * Providers a detailed view of shard allocation on nodes.
     *
     * $params['index']          = (list) A comma-separated list of index names to limit the returned information
     * $params['format']         = (string) a short version of the Accept header, e.g. json, yaml
     * $params['bytes']          = (enum) The unit in which to display byte values (Options = b,k,kb,m,mb,g,gb,t,tb,p,pb)
